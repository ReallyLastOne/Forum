...
INSERT INTO post(id,content, thread_id, author_id, creation_date) values(5, 'post5', 2, 1, '2000-11-01 5:45:55')
INSERT INTO post(id,content, thread_id, author_id, creation_date) values(6, 'post6', 2, 2, '2015-01-07 5:05:55')
INSERT INTO post(id,content, thread_id, author_id, creation_date) values(7, 'post7', 3, 3, '2005-01-06 6:25:55')
INSERT INTO post(id,content, thread_id, author_id, creation_date) values(8, 'I want to say hello to everyone', 4, 1, '2025-05-05 6:00:55')
...
insert into message(id, content, sent_date, conversation_id, receiver_id, sender_id) values (1, 'what do you think about Big Bang?', '2021-05-05 6:00:55', 1, 2, 1)
insert into message(id, content, sent_date, conversation_id, receiver_id, sender_id) values (2, 'i dont really know much', '2022-05-05 6:00:55', 1, 1, 2)
insert into message(id, content, sent_date, conversation_id, receiver_id, sender_id) values (3, 'you must read about it', '2023-05-05 6:00:55', 1, 2, 1)
insert into message(id, content, sent_date, conversation_id, receiver_id, sender_id) values (4, 'absolutely', '2024-05-05 6:00:55', 1, 1, 2)
insert into message(id, content, sent_date, conversation_id, receiver_id, sender_id) values (5, 'check wikipedia page', '2025-05-05 6:00:55', 1, 2, 1)
insert into message(id, content, sent_date, conversation_id, receiver_id, sender_id) values (6, 'or smth else', '2026-05-05 6:00:55', 1, 2, 1)

insert into message(id, content, sent_date, conversation_id, receiver_id, sender_id) values (7, 'i want to buy fire axe from you', '2002-05-05 6:00:55', 2, 1, 2)
insert into message(id, content, sent_date, conversation_id, receiver_id, sender_id) values (8, 'no way i can sell it now', '2002-06-05 6:00:55', 2, 2, 1)
insert into message(id, content, sent_date, conversation_id, receiver_id, sender_id) values (9, 'ok :(', '2002-07-05 6:00:55', 2, 2, 1)

insert into message(id, content, sent_date, conversation_id, receiver_id, sender_id) values (10, 'this is reply', '2002-06-05 7:00:55', 3, 3, 2)

insert into message(id, content, sent_date, conversation_id, receiver_id, sender_id) values (11, 'hello from me', '2022-06-05 6:00:55', 4, 4, 1)
