...
INSERT INTO `user`(id,email,name,password, register_date) values (1, 'asd@o2.com', 'ian', 'passw!1Aa3b', '2018-07-14T17:45:55.9483536')
INSERT INTO `user`(id,email,name,password, register_date) values (2, 'as2dd@o2.com', 'johhn', 'pasS2sw!1Aa3b','2018-07-14T17:45:55.9483536')
INSERT INTO `user`(id,email,name,password, register_date) values (3, 'a23sd@o2.com', 'george', 'pAassw!1Aa3b','2015-04-14T17:45:55.9483536')
INSERT INTO `user`(id,email,name,password, register_date) values (4, 'ab2sd@o2.com', 'tom', 'Passw!1SAa3b', '2018-07-14T17:45:55.9483536')
